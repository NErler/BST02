...
* Continuous variables are presented as mean and standard deviation while categorical variables as counts and percentages. Differences between males and females were analyzed by the unpaired Student's t tests for continuous variables. To investigate the association between serum bilirubin with sex, age, treatment and standardised blood clotting time a linear regression was performed. A p-value <0.05 was considered statistically significant and no correction for multiple testing was performed.
