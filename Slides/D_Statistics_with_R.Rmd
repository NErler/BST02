...
\button{https://nerler.github.io/BST02/practical/Statistics_with_R/Statistical_Tests.html}{html}
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\begin{block}{Demo}
\begin{itemize}
\item Regression Basics\newline \button{https://nerler.github.io/BST02/demo/Statistics_with_R/Regression.R}{R}
\button{https://nerler.github.io/BST02/demo/Statistics_with_R/Regression.html}{html}
\end{itemize}
\end{block}
\end{column}
