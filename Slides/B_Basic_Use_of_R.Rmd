...
* Every object in R has a class
  ...
  - \textbf{\textcolor{red}{Vectors}} have the same type of elements with the same length (one dimension)
  - \textbf{\textcolor{red}{Matrices}} have the same type of elements with the same length (two dimensions)
  - \textbf{\textcolor{red}{Data.frames}} have elements of different type with the same length (two dimensions)
  - \textbf{\textcolor{red}{Lists}} have elements of different type and length (any dimension)
...
\begin{block}{Demos}
\begin{itemize}
\item Shiny app indexing subsetting \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/08_shiny_app_indexing.R}{R} 
\end{itemize}
\end{block}
\end{column}
\end{columns}
