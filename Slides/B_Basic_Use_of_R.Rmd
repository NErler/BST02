...
* Differences between \textbf{\textcolor{red}{Vector}}, Matrices, Data.frames and Lists
```{r, eval = TRUE, include = TRUE, echo = TRUE}
pbc[1:6, c("age")]
```
...
* Specialized functions for importing data from other statistical packages
  ...
  - package: \textbf{\textcolor{red}{haven}}, functio: \textbf{\textcolor{red}{read\_spss()}}
  - etc
...
* Specialized functions for importing data from other statistical packages
  - function: \textbf{\textcolor{red}{read.table()}}, \textbf{\textcolor{red}{read.csv()}}
