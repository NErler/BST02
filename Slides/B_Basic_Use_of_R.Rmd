...
\begin{itemize}
\item Basic R 
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/01_Basic_R.R}{R} \button{https://nerler.github.io/BST02/demo/basic-use-of-r/01_Basic_R.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/02_Common_R_objects.R}{R} \button{https://nerler.github.io/BST02/demo/basic-use-of-r/02_Common_R_objects.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/03_Importing_Saving.R}{R} 
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/03_Importing_Saving.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/04_Data_Transformation.R}{R} \button{https://nerler.github.io/BST02/demo/basic-use-of-r/04_Data_Transformation.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/05_Data_Exploration.R}{R} 
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/05_Data_Exploration.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/06_Data_Visualization.R}{R} \button{https://nerler.github.io/BST02/demo/basic-use-of-r/06_Data_Visualization.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\begin{block}{Demos}
\begin{itemize}
\item Shiny app indexing subsetting \button{https://nerler.github.io/BST02/demo/basic-use-of-r/08_shiny_app_indexing.R}{R} 
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\button{https://nerler.github.io/BST02/demo/basic-use-of-r/07_Indexing_Subsetting.R}{R} \button{https://nerler.github.io/BST02/demo/basic-use-of-r/07_Indexing_Subsetting.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\begin{itemize}
\item Basic Use R \button{https://nerler.github.io/BST02/practical/basic-use-of-r/Basic_Use_R.html}{html}
\end{itemize}
\end{block}
\end{column}
\end{columns}
