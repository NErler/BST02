...
\begin{itemize}
\item Basic R 
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/01_Basic_R.R}{R} \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/01_Basic_R.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/02_Common_R_objects.R}{R} \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/02_Common_R_objects.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/03_Importing_Saving.R}{R} 
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/03_Importing_Saving.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/04_Data_Transformation.R}{R} \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/04_Data_Transformation.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/05_Data_Exploration.R}{R} 
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/05_Data_Exploration.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/06_Data_Visualization.R}{R} \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/06_Data_Visualization.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\begin{block}{Demos}
\begin{itemize}
\item Indexing Subsetting shiny app \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/08_shiny_app_indexing.R}{R} \
\end{itemize}
\end{block}
\end{column}
...
In order to run the app you will need to install the packages `survival` and `shiny`
...
\button{https://nerler.github.io/BST02/demo/Basic_use_of_R/07_Indexing_Subsetting.R}{R} \button{https://nerler.github.io/BST02/demo/Basic_use_of_R/07_Indexing_Subsetting.html}{html}
\end{itemize}
\end{block}
\end{column}
