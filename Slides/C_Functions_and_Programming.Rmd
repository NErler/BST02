...
\begin{block}{Demos}
\begin{itemize}
\item Functions for Data Exploration \button{link to R file}{R} \button{link to html file}{html}
\end{itemize}
\end{block}
\end{column}
...
\begin{itemize}
\item Exploring and Summarizing Data \button{link to html file}{html}
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\begin{block}{Demo}
\begin{itemize}
\item Functions for Data Manipulation \button{link to R file}{R} \button{link to html file}{html}
\end{itemize}
\end{block}
\end{column}
...
\begin{block}{Practicals}
\begin{itemize}
\item Merging Data \button{link to html file}{html}
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
```{r, eval = FALSE}
if (cond) {expression} else {alternative expression}
```
...
\begin{block}{Demo}
\begin{itemize}
\item Control Flow \button{link to R file}{R} \button{link to html file}{html}
\end{itemize}
\end{block}
\end{column}
...
\begin{block}{Practical}
\begin{itemize}
\item Control Flow and Functions \button{https://nerler.github.io/BST02/practical/Functions and Programming/Rolling_the_Dice.html}{html}
\end{itemize}
\end{block}
\end{column}
\end{columns}
...
\item \blue{\texttt{if (condition) expression1 else expression2}}:\newline
   evaluates `expression1` if the 
  `condition` is `TRUE` and `expression2` if the `condition` is `FALSE`
\item \blue{\texttt{ifelse(test, yes, no)}}:\newline
   expects a vector of `test`s
...
* Manipulate slices of data from matrices, data frames and lists in a repetitive way avoiding explicit use of loop-constructs
...
\begin{block}{Demos}
\begin{itemize}
\item Indexing Subsetting shiny app \button{shiny_app_apply_family.R}{R} \
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/Functions_and_Programming/01_The_Apply_Family.R}{R} \button{https://nerler.github.io/BST02/demo/Functions_and_Programming/01_The_Apply_Family.html}{html}
\end{itemize}
\end{block}
\end{column}
