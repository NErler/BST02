...
\begin{block}{Demo}
\begin{itemize}
\item Control Flow \button{https://nerler.github.io/BST02/demo/functions-and-programming/Control_Flow.R}{R} \item Rolling the Dice \button{https://nerler.github.io/BST02/demo/functions-and-programming/Control_Flow.html}{html}
\end{itemize}
\end{block}
\end{column}
...
\button{https://nerler.github.io/BST02/demo/functions-and-programming/01_The_Apply_Family.R}{R} \button{https://nerler.github.io/BST02/demo/functions-and-programming/01_The_Apply_Family.html}{html}
\end{itemize}
\end{block}
\end{column}
