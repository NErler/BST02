...
Use the function plot(..., xlab, ylab, col). Note that colour should be a number (use the function as.numeric(...)). Use the function legend(...) to add a legend to the plot.
</div>')
```
