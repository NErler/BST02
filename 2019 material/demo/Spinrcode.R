...
#' Continuous data are presented as mean±standard deviation while categorical
#'  variables as counts and percentages. Differences between groups were 
#'  analyzed by the unpaired Student's t tests for continuous variables while....
#'   To investigate the association between weight with sex, age and BMI, a 
#'   linear regression was performed... A p-value <0.05 was considered
...
#+ r makeplot1, echo=FALSE, include=TRUE
plot(dat$weight, dat$BMI, xlab = "weight", ylab = "BMI")


#+ r makeplot2, echo=FALSE, include=TRUE
